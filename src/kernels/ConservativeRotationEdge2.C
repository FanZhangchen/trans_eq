...
#include "ConservativeRotationEdge2.h"
#include "SystemBase.h"
#include "libmesh/utility.h"

registerMooseObject("TransEQApp", ConservativeRotationEdge2);

InputParameters
ConservativeRotationEdge2::validParams()
{
...
ConservativeRotationEdge2::ConservativeRotationEdge2(const InputParameters & parameters)
  : Kernel(parameters),
    ...
    _upwind_node(0),
    _dtotal_mass_out(0),
    _rho_screw_2(coupledValue("rho_screw_2"))
{
}

Real
ConservativeRotationEdge2::negSpeedQp()
{
  Real edge_sign;
  Real screw_sign;
  Real vel;
...
Real
ConservativeRotationEdge2::computeQpResidual()
{
...
Real
ConservativeRotationEdge2::computeQpJacobian()
{
  // This is the no-upwinded version
...
void
ConservativeRotationEdge2::computeResidual()
{
  switch (_upwinding)
  {
...
void
ConservativeRotationEdge2::computeJacobian()
{
  switch (_upwinding)
  {
    case UpwindingType::none:
...
void
ConservativeRotationEdge2::fullUpwind(JacRes res_or_jac)
{
