...
[Kernels]
  [./TensorMechanics]
    ...
    add_variables = true
    generate_output = 'deformation_gradient_xx deformation_gradient_xy deformation_gradient_yy strain_xy'
  [../]
...
[Outputs]
  ...
  [csv]
    type = CSV
    file_base = rhoe_x_out_l5e-2_BLP_rho0_double_60120
    execute_on = final
  []
[]
