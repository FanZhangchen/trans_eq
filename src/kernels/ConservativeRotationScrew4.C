...
#include "ConservativeRotationScrew4.h"
#include "SystemBase.h"
#include "libmesh/utility.h"

registerMooseObject("TransEQApp", ConservativeRotationScrew4);

InputParameters
ConservativeRotationScrew4::validParams()
{
...
ConservativeRotationScrew4::ConservativeRotationScrew4(const InputParameters & parameters)
  : Kernel(parameters),
    ...
    _upwind_node(0),
    _dtotal_mass_out(0),
    _rho_edge_4(coupledValue("rho_edge_4"))
{
}

Real
ConservativeRotationScrew4::negSpeedQp()
{
  Real edge_sign;
  Real screw_sign;
...
Real
ConservativeRotationScrew4::computeQpResidual()
{
...
Real
ConservativeRotationScrew4::computeQpJacobian()
{
  // This is the no-upwinded version
...
void
ConservativeRotationScrew4::computeResidual()
{
  switch (_upwinding)
  {
...
void
ConservativeRotationScrew4::computeJacobian()
{
  switch (_upwinding)
  {
    case UpwindingType::none:
...
void
ConservativeRotationScrew4::fullUpwind(JacRes res_or_jac)
{
