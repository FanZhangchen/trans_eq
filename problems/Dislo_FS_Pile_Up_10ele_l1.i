...
[Mesh]
  ...
  [jungle_all]
    ...
    new_boundary = jungle_all
    bottom_left = '-0.05 0.05 -0.05'
    top_right = '1.05 0.15 0.15'
    input = generated_mesh
  []
  [jungle_1]
    type = BoundingBoxNodeSetGenerator
    new_boundary = jungle_1
    bottom_left = '-0.05 0.05 0.00005'
    top_right = '0.00005 0.15 0.15'
    input = jungle_all
  []
  [jungle_2]
    type = BoundingBoxNodeSetGenerator
    new_boundary = jungle_2
    bottom_left = '0.00005 0.05 -0.05'
    top_right = '1.05 0.15 0.15'
    input = jungle_1
  []
[]
