...
/**
 * ShearTraction applies a shear stress on a given boundary in the direction defined by component
 */
class ShearTraction : public IntegratedBC
{
public:
  static InputParameters validParams();

  ShearTraction(const InputParameters & parameters);
