 ...
 * material state. The internal variables are updated using an interative predictor-corrector
 * algorithm. Backward Euler integration rule is used for the rate equations. Temperature dependence
 * of the CRSS. Dislocation based model. Calculation of the dislocation velocity depending on
 * resolved shear stress. CRSS is calculated using Taylor hardening law and bow-out curvature term
 * for line tension.
 */
