...
#include "BCMaterial.h"

registerMooseObject("TransEQApp", BCMaterial);

InputParameters
BCMaterial::validParams()
{
...
BCMaterial::BCMaterial(const InputParameters & parameters)
...
void
BCMaterial::initQpStatefulProperties()
{
  _velocity[_qp] = _initial_velocity;
}

void
BCMaterial::computeQpProperties()
{
