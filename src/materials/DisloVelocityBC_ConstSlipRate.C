...
#include "DisloVelocityBC_ConstSlipRate.h"
...
registerMooseObject("TransEQApp", DisloVelocityBC_ConstSlipRate);

InputParameters
DisloVelocityBC_ConstSlipRate::validParams()
{
...
DisloVelocityBC_ConstSlipRate::DisloVelocityBC_ConstSlipRate(const InputParameters & parameters)
...
void
DisloVelocityBC_ConstSlipRate::initQpStatefulProperties()
{
...
void
DisloVelocityBC_ConstSlipRate::computeQpProperties()
{
